module.exports = function(grunt) {
        ...
        concat: {
            lessCore: {
                src: [
                    ...
                    'web/bundles/app/less/main.less',
                    'web/bundles/altawaypage/less/page.less',
                    'web/bundles/altawayoffer/less/offer.less'
                ],
            ...
            jsCore: {
                src: [
                    'web/bundles/vendor/bootstrap-sweetalert/lib/sweet-alert.js',
					'web/bundles/altawayuser/js/collection_buttons.js'
                ],
    ...
    grunt.registerTask('css:dev', ['symlink:app', 'symlink:vendor', 'concat:lessCore', 'less:discovering', 'less', 'initDirectoryImages', 'symlink:*']);
